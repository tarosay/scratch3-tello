...
const message = {
    connectTo: {
        ...
        'ja-Hira': '[SSID] につなぐ',
        'en': 'connect to [SSID]',
        'ru': 'подключиться к [SSID]',
        'fr': 'se connecter à [SSID]',
        'de': 'zu [SSID] verbinden',
        'bg': 'свързване с [SSID]',
        'zh-tw': '連線到 [SSID]',
        'zh-cn': '连接到 [SSID]',
        'it': 'connettersi a [SSID]',
        'lv': 'pieslēgties [SSID]',
        'ua': 'підключитися до [SSID]',
    },
    takeoff: {
        'ja': '離陸する',
        'ja-Hira': 'りりくする',
...
class Scratch3Tello {
    ...
    connectTo(args) {
        ...
        return this.telloProcessor.selectDroneBySsid(ssid);
    }
